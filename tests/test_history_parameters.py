...
def test_history_subarrays():
    """Test storage of multidimensional subarrays in history.

    Two way of doing this are tested, with a dtype with predefined
    size, and with an `object` dtype.
    """
    ...
    exploration = Exploration(
        ...
        max_evals=10,
        sim_workers=2,
        exploration_dir_path="./tests_output/test_history_subarrays",
    )
